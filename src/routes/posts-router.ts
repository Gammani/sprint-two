...
postsRouter.post('/', (req: RequestWithBody<CreatePostModel>, res: Response<PostViewModel>) => {
...
postsRouter.put('/:id', (req: RequestWithParamsAndBody<URIParamsPostIdModel, UpdatePostModel>, res) => {
...
postsRouter.delete('/:id', (req: RequestWithParams<URIParamsPostIdModel>, res) => {
